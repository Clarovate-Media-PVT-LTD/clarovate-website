        ...
        <section className="bg-gradient-to-b from-fire-900 via-fire-800 to-fire-700 py-16 text-white md:py-20">
          <div className="mx-auto flex max-w-4xl flex-col gap-4 px-6 text-center">
            ...
            <p className="mx-auto max-w-2xl text-sm text-white/80 md:text-base">
              These terms ensure every Clarovate engagement is anchored in
              trust, transparency, and measurable outcomes. Please review them
          ...
          <article className="space-y-10 rounded-[32px] border border-fire-100 bg-white/95 p-8 shadow-[0_25px_50px_-28px_rgba(131,46,4,0.35)] md:p-12">
            <section className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-gray-700 md:text-base">
                Clarovate delivers the demand generation programs outlined in
                your master services agreement or statement of work. Scope
                changes must be mutually agreed to in writing and may impact
                timelines or fees.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-gray-700 md:text-base">
                ...
                <li>
                  • Review deliverables within the agreed feedback cycles.
                </li>
                <li>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-gray-700 md:text-base">
                ...
                <li>
                  • Report progress on the cadence agreed to (typically weekly
                  or bi-weekly).
                </li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-gray-700 md:text-base">
                Either party may terminate for material breach with written
                notice and an opportunity to cure. Clarovate’s liability is
                limited to the fees paid in the previous 90 days, and we are not
            ...
            <section className="rounded-2xl border border-fire-100 bg-fire-50/80 p-6 text-sm leading-relaxed text-gray-700 shadow-inner md:text-base">
              These terms complement any signed master services agreement. In
              the case of conflict, the signed agreement governs. For privacy or
